...
exports.buildRequestUrl = function(options) {
  ...
  switch (serviceName) {
    case 'Finding':
      if (options.sandbox) url = 'https://svcs.sandbox.ebay.com/services/search/FindingService/v1';
    ...
    case 'Merchandising':
      if (options.sandbox) url = 'https://svcs.sandbox.ebay.com/MerchandisingService';
